...
/*! \file
    \brief Header file for stdGYS char type.
*/

#ifndef __GYS_CHAR_TYPE_
#define __GYS_CHAR_TYPE_

#include "..\gys.h"

static const char* gys_char_type = "char"; // char stdGYS type

GYS_ret_val& store(GYS_ret_val& val, char char_user_val);

GYS_ret_val get_char_val(GYS* script);

void add_char_type(GYS* script);
