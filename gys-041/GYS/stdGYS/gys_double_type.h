...
/*! \file
    \brief Header file for stdGYS double type.
*/

#ifndef __GYS_DOUBLE_TYPE_
#define __GYS_DOUBLE_TYPE_

#include "..\gys.h"

static const char* gys_double_type = "double"; //!< double stdGYS type

GYS_ret_val& store(GYS_ret_val& val, double double_user_val);

GYS_ret_val get_double_val(GYS* script);

void add_double_type(GYS* script);
