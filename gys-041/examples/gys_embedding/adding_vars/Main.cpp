...
int main(int argc, char* argv[])
{
	...
	// adding VERSION global const (why const? - because we use GYS var decl syntax in next function)
	s.add_global_var("@VERSION", "0.4.0 Alpha");
	//s.add_local_var("@VERSION", "0.4.0 Alpha");
